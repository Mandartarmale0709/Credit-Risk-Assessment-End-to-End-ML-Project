...
st.sidebar.info("""
This loan eligibility predictor uses a machine learning model trained on the Prosper dataset.
The model evaluates your application based on various factors and predicts whether you're eligible for a loan.

**Prediction Categories:**
- **Eligible for Loan**: You are likely to be approved for the loan.
- **High Credit Risk**: You may not be eligible for the loan due to high credit risk.

**Note:** This is a predictive model and actual loan decisions may involve additional factors.
""")

# Tips for improving loan eligibility
st.sidebar.header("Tips for Improving Loan Eligibility")
st.sidebar.markdown("""
- Maintain a credit score above 700
- Keep a steady income source
- Reduce existing debt
- Avoid loan delinquencies
- Apply for a loan amount appropriate to your income
""")